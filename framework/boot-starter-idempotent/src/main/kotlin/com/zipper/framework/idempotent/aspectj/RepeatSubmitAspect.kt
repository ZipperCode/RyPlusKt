package com.zipper.framework.idempotent.aspectj
...
class RepeatSubmitAspect {
    ...
    fun doBefore(point: JoinPoint, repeatSubmit: RepeatSubmit) {
        ...
        val request = ServletUtils.getRequest() ?: throw ServiceException("获取当前请求为空")
        ...
        // 唯一值（没有消息头则使用请求地址）
        var submitKey: String = StringUtils.trimToEmpty(request.getHeader(SaManager.getConfig().tokenName))
